...
use App\Http\Controllers\MatchedController;
...
Route::get('/matcheds',[MatchedController::class,'index']);
Route::post('/matcheds',[MatchedController::class,'store']);
Route::put('/matcheds/{id}',[MatchedController::class,'update']);
Route::delete('/matcheds/{id}',[MatchedController::class,'destroy']);
